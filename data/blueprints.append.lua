...
systemsToAppend["lily_targeting_core"] = {
    ...
    image_list = {
        ...
        { room_image = "room_lily_target_core_41", w = 3, h = 1, top = "011", bottom = "000", left = "0",   right = "0",   manning_slot = 1, manning_direction = "up" },
        ...
        { room_image = "room_lily_target_core_44", w = 1, h = 3, top = "0",   bottom = "0",   left = "000", right = "011", manning_slot = 1, manning_direction = "right" },
