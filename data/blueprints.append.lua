...
systemsToAppend["lily_shock_neutralizer"] = {
    ...
    manning = false,
    replace_sys = "battery",
    image_list = { { room_image = "room_battery", w = 2, h = 1, top = "11", bottom = "00", left = "0", right = "1"},
        { room_image = "room_battery_1", w = 2, h = 1, top = "0", bottom = "0", left = "1", right = "0"},
        { room_image = "room_battery_2", w = 2, h = 1, top = "11", bottom = "00", left = "0", right = "0"},
        { room_image = "room_battery_3", w = 2, h = 1, top = "11", bottom = "01", left = "11", right = "10"},
        { room_image = "room_battery_4", w = 2, h = 2, top = "10", bottom = "10", left = "00", right = "11"},
        { room_image = "room_battery_5", w = 1, h = 2, top = "1", bottom = "0", left = "00", right = "11"},
        { room_image = "room_battery_6", w = 1, h = 2, top = "0", bottom = "0", left = "11", right = "00"},
        { room_image = "room_battery_7", w = 2, h = 1, top = "00", bottom = "00", left = "1", right = "1"},
        { room_image = "room_battery_8", w = 1, h = 2, top = "0", bottom = "0", left = "01", right = "10"},
        { room_image = "room_battery_9", w = 2, h = 1, top = "00", bottom = "11", left = "1", right = "0"},
        { room_image = "room_battery_10", w = 1, h = 2, top = "0", bottom = "0", left = "00", right = "11"},
        { room_image = "room_battery_11", w = 1, h = 2, top = "0", bottom = "1", left = "01", right = "00"},
        { room_image = "room_battery_12", w = 2, h = 1, top = "10", bottom = "00", left = "0", right = "1"},
        { room_image = "room_battery_13", w = 2, h = 1, top = "10", bottom = "10", left = "0", right = "0"},
        { room_image = "room_battery_14", w = 2, h = 1, top = "00", bottom = "11", left = "0", right = "0"},
        { room_image = "room_battery_15", w = 1, h = 2, top = "0", bottom = "0", left = "00", right = "01"},
        { room_image = "room_battery_16", w = 1, h = 2, top = "0", bottom = "0", left = "11", right = "00"},
        { room_image = "room_battery_17", w = 1, h = 2, top = "0", bottom = "0", left = "10", right = "10"},
        { room_image = "room_battery_18", w = 1, h = 2, top = "0", bottom = "0", left = "10", right = "01"},
        { room_image = "room_battery_19", w = 2, h = 1, top = "10", bottom = "00", left = "1", right = "0"},
        --{room_image = "room_shields_aea_r", w = 2, h = 2, top = "01", bottom = "10", left="11", right="00", manning_slot = 1, manning_direction = "up"},
        --{room_image = "room_shields_aea_rr", w = 2, h = 2, top = "11", bottom = "00", left="10", right="01", manning_slot = 3, manning_direction = "right"},
        --{room_image = "room_shields_aea_rrr", w = 2, h = 2, top = "01", bottom = "10", left="00", right="11", manning_slot = 2, manning_direction = "down"},
        --{ room_image = "room_shields_2",  w = 2, h = 2, top = "10", bottom = "00", left = "10", right = "01", manning_slot = 0, manning_direction = "left" },
